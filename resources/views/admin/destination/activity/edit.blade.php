...
<div class="card">
    <div class="card-body">
        <form action="/admin/destination/{{$destinationId}}/activity/{{$activity->id}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <img src="{{ asset('images/' . $activity->image) }}" style="height: 200px; width: 200px; object-fit: cover;" class="destination-image" alt="">
